    ...
    <DashboardLayout title="تفاصيل طلب التصميم">
      <div className="max-w-4xl space-y-4 animate-fade-in">
        <div className="flex items-center justify-between">
          <Link href="/design" className="flex items-center gap-1 text-slate-500 hover:text-slate-200 transition-colors text-sm">
            <BackArrow className="w-4 h-4" />{t('common.back')}
          </Link>
          <div className="flex gap-2">
            <Link href={`/design/${id}/edit`}><Button variant="outline" size="sm" icon={<Pencil className="w-3.5 h-3.5" />}>{t('common.edit')}</Button></Link>

...
export default function EditOutsourcedOrderPage() {
  ...
  return (
    <DashboardLayout title="تعديل طلب الطباعة الخارجية">
      <div className="max-w-3xl"><div className="bg-white border border-slate-200 shadow-sm rounded-xl p-6"><OutsourcedOrderForm initial={order} onSubmit={handleSubmit} loading={loading} /></div></div>
    </DashboardLayout>
  );
}

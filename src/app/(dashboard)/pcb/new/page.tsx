...
export default function NewPCBOrderPage() {
  ...
  return (
    <DashboardLayout title="طلب طباعة PCB جديد">
      <div className="max-w-3xl"><div className="bg-white border border-slate-200 shadow-sm rounded-xl p-6"><PCBOrderForm onSubmit={handleSubmit} loading={loading} /></div></div>
    </DashboardLayout>
  );
}
